...
from torchkit.pytorch_utils import device
...
def main():
    ...
    if args.transform_data_bamdp:
        ...
        _, goals = off_utl.load_dataset(data_dir='data', args=args, arr_type='numpy')
        # goals = np.array([[i] for i in range(len(dataset))])
