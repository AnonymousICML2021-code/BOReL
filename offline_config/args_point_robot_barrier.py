...
def get_args(rest_args):
    ...
    parser.add_argument('--num-train-tasks', default=60)
    parser.add_argument('--num-eval-tasks', default=5)
    ...
    parser.add_argument('--output-file-prefix', default='no_replaying_60')
    # parser.add_argument('--output-file-prefix', default='offline_no_rr')

    parser.add_argument('--relabelled-data-dir', default='data_bamdp_no_replaying_60')
    ...
    parser.add_argument('--vae-model-name', default='no_replaying_60')
