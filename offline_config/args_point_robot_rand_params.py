...
def get_args(rest_args):
    ...
    parser.add_argument('--num-iters', type=int, default=2000, help='number meta-training iterates')
    ...
    parser.add_argument('--policy-layers', nargs='+', default=[64, 64])
    ...
    parser.add_argument('--output-file-prefix', default='no_replaying')
    parser.add_argument('--relabelled-data-dir', default='data_bamdp_no_replaying')
    parser.add_argument('--data-dir', default='data')
    parser.add_argument('--main-data-dir', default='./batch_data')
    parser.add_argument('--vae-dir', default='./trained_vae')

    # parser.add_argument('--vae-model-name', default='no_relabel_rand_init__24_11_01_08_14')
    parser.add_argument('--vae-model-name', default='no_replaying__03_02_23_59_23')
