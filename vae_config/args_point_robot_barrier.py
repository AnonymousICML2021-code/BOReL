...
def get_args(rest_args):
    ...
    parser.add_argument('--env-name', default='PointRobotBarrier-v0')
    ...
    parser.add_argument('--policy-replaying', type=int, default=False)
    parser.add_argument('--replaying-data-dir', default='hindsight_data_60')
    ...
    parser.add_argument('--input-prev-state', default=True, help='use prev state for rew pred')
    parser.add_argument('--input-next-state', default=False, help='use prev state for rew pred')
    parser.add_argument('--input-action', default=True, help='use prev action for rew pred')
    parser.add_argument('--reward-decoder-layers', nargs='+', type=int, default=[32, 32])
    parser.add_argument('--rew-pred-type', type=str, default='bernoulli', help='choose from: bernoulli, deterministic')
    ...
    parser.add_argument('--decode-state', default=True)
    ...
    parser.add_argument('--state-pred-type', type=str, default='deterministic', help='choose from: bernoulli, deterministic')
    ...
    parser.add_argument('--eval-interval', default=5)

    parser.add_argument('--main-data-dir', default='./batch_data')
    parser.add_argument('--data-dir', default='data')
    parser.add_argument('--save-dir-prefix', default='no_replaying_60')
