...
def get_args(rest_args):
    ...
    parser.add_argument('--env-name', default='PointRobotRandParams-v0')
    ...
    parser.add_argument('--replaying-data-dir', default='hindsight_data')
    ...
    parser.add_argument('--kl-weight', type=float, default=0.05, help='weight for the KL term')
    ...
    parser.add_argument('--input-next-state', default=True, help='use prev state for rew pred')
    ...
    parser.add_argument('--state-pred-type', type=str, default='deterministic',
    ...
    parser.add_argument('--save-interval', default=50)
    ...
    parser.add_argument('--save-dir-prefix', default='no_replaying')
