...
register(
    'PointRobotRandParams-v0',
    entry_point='environments.toy_navigation.point_robot:PointEnvRandDynamics',
    kwargs={'max_episode_steps': 25, 'n_tasks': 2, 'goal_radius': 0.2},
)

register(
    'PointRobotBarrier-v0',
    entry_point='environments.toy_navigation.point_robot_barrier:PointEnvBarrier',
    kwargs={'max_episode_steps': 60, 'n_tasks': 2},
)
